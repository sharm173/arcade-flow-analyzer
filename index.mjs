...
function buildMarkdown(flowName, interactions, summary, imagePath, caption) {
  const lines = [];
  ...
  lines.push(`\n---\n## 3) ![Social Media Image](${imagePath} "Social Media Image Generated by AI")\`.`);
  lines.push(`\n**Suggested caption:**\n> ${caption}`);
...
async function main() {
  ...
  const md = buildMarkdown(flowName, interactions, summary, imagePath, caption);
